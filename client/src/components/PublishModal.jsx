            ...
            w-full p-6 mx-4 relative">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input type="text" value={publishUrl} readOnly className="w-full px-0
                    ...
                    <div className="flex gap-2 pt-2">
                        ...
                        text-white text-xs font-medium hover:bg-zinc-800 cursor-pointer
                        rounded-lg text-center">
                           Copy Link  
                        </button> 
                        <button 
                        onClick={()=>window.open(publishUrl,"_blank")} 
                        className="flex-1 py-2 bg-zinc-50
                        text-zinc-900 text-xs font-medium hover:bg-zinc-100 cursor-pointer
                        rounded-lg text-center">
                           Open Site 
                        </button> 
                    </div>
